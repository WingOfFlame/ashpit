...
/**
 * Classes implementing <code>IWordList</code> provide a list of word-difficulty
 * pairs ({@link Word} objects).
 *
 * <p>
 * The <code>becker</code> library contains a file of approximately 4,250
 * word-difficulty pairs. This file may be opened with the following code:</p>
 * <pre>
 * import java.io.*;
 * ...
 ...
 *
 * <p>
 * Alternatively, the file may be downloaded <a
 * href="doc-files/words.txt">here</a>.</p>
 *
...
public interface IWordList {
    ...
    /**
     * Does the list of words contain a word-difficulty pair with the given
     * word?
     *
    ...
    /**
     * Find a random word with the given difficulty in the list. The list must
     ...
     * a {@link Hint} object (which implements IWordPredicate). The method
     * should start with a random word in the list and then proceed sequentially
     * through the list until it either finds a word that passes the test or it
     * it exhausts the list, in which case it returns <code>null</code>.
     *
     * @param test The test that the Word must pass
     * @return a word passing the test or <code>null</code> if no such word
     * exists.
     */
    public Word getWord(IWordPredicate test);

    /**
     * Find all the words that pass the given test; the test is typically given
     * by a {@link Hint} object (which implements IWordPredicate).
     *
     ...
     * typically given by a {@link Hint} object (which implements
     * IWordPredicate).
     *
