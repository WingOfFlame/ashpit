...
public class Word extends Object {
     ...
     * <p>
     * File format is a word followed by its difficulty, one pair per line. The
     * difficulty must be in the range of 0..2. The file cursor is expected
     * immediately before the word and will be left immediately before the
     * following word in the file. For example:</p>
     * <pre>TRUCK 0
     *FOLLY 1
     *LIGHT 0
     *EMBAY 2
